...
class srcApp_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\StoreController' => 'getStoreControllerService.php',
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'CoffeeBikeOwasysBundle' => [
                    'path' => ($this->targetDirs[3].'/vendor/coffeebike/owasys-bundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'CoffeeBikeOwasysBundle' => 'CoffeeBike\\OwasysBundle\\CoffeeBikeOwasysBundle',
            ...
            'coffee_bike_owasys.server.address' => 'localhost',
