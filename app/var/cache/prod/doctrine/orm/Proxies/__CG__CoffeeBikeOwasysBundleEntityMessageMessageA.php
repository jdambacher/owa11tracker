 ...
 */
class MessageA extends \CoffeeBike\OwasysBundle\Entity\Message\MessageA implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageA' . "\0" . 'reason', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageA' . "\0" . 'info', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageA' . "\0" . 'km'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MessageA $proxy) {
