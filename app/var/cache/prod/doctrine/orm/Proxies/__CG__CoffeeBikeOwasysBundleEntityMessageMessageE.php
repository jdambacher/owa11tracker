 ...
 */
class MessageE extends \CoffeeBike\OwasysBundle\Entity\Message\MessageE implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageE' . "\0" . 'errorCode', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageE' . "\0" . 'text'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MessageE $proxy) {
