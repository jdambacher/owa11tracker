 ...
 */
class MessageX extends \CoffeeBike\OwasysBundle\Entity\Message\MessageX implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageX' . "\0" . 'version', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageX' . "\0" . 'imei', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageX' . "\0" . 'imsi', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageX' . "\0" . 'bootloader'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MessageX $proxy) {
    ...
    public function setBootloader($bootloader)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBootloader', [$bootloader]);

        return parent::setBootloader($bootloader);
    }
    ...
    public function getBootloader()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBootloader', []);

        return parent::getBootloader();
    }
