 ...
 */
class MessageF extends \CoffeeBike\OwasysBundle\Entity\Message\MessageF implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'externalVoltage', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'internalVoltage', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'movement', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'positionAccuracy', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'latitude', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'longitude', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'cellId', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'lac', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'plmn', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'rssi', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'gpsCoverage', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'traveledKms', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'gpsSpeed', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'lastValidPositionTimestamp', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'outsideGeofenceFlag', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageF' . "\0" . 'courseOverGround'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MessageF $proxy) {
