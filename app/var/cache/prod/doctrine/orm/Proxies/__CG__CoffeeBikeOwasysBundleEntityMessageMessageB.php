 ...
 */
class MessageB extends \CoffeeBike\OwasysBundle\Entity\Message\MessageB implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CoffeeBike\\OwasysBundle\\Entity\\Message\\MessageB' . "\0" . 'byeCode'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MessageB $proxy) {
    ...
    public function setByeCode($byeCode)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setByeCode', [$byeCode]);

        return parent::setByeCode($byeCode);
    }
    ...
    public function getByeCode()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getByeCode', []);

        return parent::getByeCode();
    }
